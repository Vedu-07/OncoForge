...
const geminiApiKey = import.meta.env.VITE_APP_GEMINI_API;
  ...
  return (
    <div className="flex flex-wrap gap-[26px]">
      <button
        ...
        className="mt-6 inline-flex items-center gap-x-2 rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-800 shadow-sm hover:bg-gray-50 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700"
      >
        <IconFileUpload />
        Upload Reports
      </button>
        ...
        <div className="flex flex-col">
          <div className="-m-1.5 overflow-x-auto">
            <div className="inline-block min-w-full p-1.5 align-middle">
              <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-neutral-700 dark:bg-gray-800">
                ...
                <div className="flex w-full flex-col px-6 py-4 text-white">
                  ...
                  <div className="mt-5 grid gap-2 sm:flex">
                    <button
                      ...
                      className="inline-flex items-center gap-x-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-800 shadow-sm hover:bg-gray-700 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700"
                    >
                      View Treatment plan
