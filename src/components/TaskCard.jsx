...
function TaskCard({ task, deleteTask, updateTask }) {
  ...
  if (editMode) {
    return (
      <div
        ...
        {...attributes}
        {...listeners}
        className="relative flex h-[100px] min-h-[100px] cursor-grab items-center rounded-xl bg-gray-700 p-2.5 text-left hover:ring-2 hover:ring-inset hover:ring-gray-500"
      >
        <textarea
  ...
  return (
    <div
      ...
      className="task relative flex h-[100px] min-h-[100px] cursor-grab items-center rounded-xl bg-gray-700 p-2.5 text-left hover:ring-2 hover:ring-inset hover:ring-green-500"
      onMouseEnter={() => {
        setMouseIsOver(true);
      }}
      onMouseLeave={() => {
